...
namespace sfc.BO
{
    public class bulk_pack_upload
    {
        ...
        public bulk_pack_upload(batch bat)
        {
            _lotno = bat.lotno;
        ...
        public bulk_pack_upload(lot lot_no, product prod, line line_id, string parte)
        {
            _lotno = lot_no;
            _product = prod;
            _line = line_id;
        ...
        public bulk_pack_upload(string lot_no, string prod, string line_id, string parte)
        {
