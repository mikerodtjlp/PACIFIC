...
namespace sfc.BO
{
    public class batch_lot
    {
        private lot _lotno;
        private product _product;
        private line _line;

        public batch_lot(batch bat)
        {
            _lotno = bat.lotno;
        ...
        public batch_lot(lot lot_no, product prod, line line_id, string parte)
        {
            _lotno = lot_no;
            _product = prod;
            _line = line_id;
        ...
        public batch_lot(string lot_no, string prod, string line_id, string parte)
        {
        ...
        public int number_of_bulk_packs { get; set; }
