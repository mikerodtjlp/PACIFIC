...
namespace sfc.BO
{
    public class postcured_data
    {
        private lot _lotno;
        private product _product;
        private line _line;

        public postcured_data(batch bat)
        {
            _lotno = bat.lotno;
        ...
        public postcured_data(lot lot_no, product prod, line line_id, string parte)
        {
            _lotno = lot_no;
            _product = prod;
            _line = line_id;
        ...
        public postcured_data(string lot_no, string prod, string line_id, string parte)
        {
