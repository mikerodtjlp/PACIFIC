...
namespace sfc.BO
{
    public class production_inventory
    {
        private lot _lotno;
        private product _product;
        private line _line;

        public production_inventory(batch bat)
        {
            _lotno = bat.lotno;
        ...
        public production_inventory(lot lot_no, product prod, line line_id)
        {
            _lotno = lot_no;
            _product = prod;
            _line = line_id;
        ...
        public production_inventory(lot lot_no, product prod, line line_id, resource res)
        {
            _lotno = lot_no;
            _product = prod;
            _line = line_id;
        ...
        public production_inventory(string lot_no, string prod, string line_id)
        {
        ...
        public production_inventory(string lot_no, string prod, string line_id, string res)
        {
            var lt = new lot(lot_no);
            var p = new product(prod);
            var ln = new line(line_id);
